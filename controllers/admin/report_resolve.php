...
WHERE transaction_id = ?;")) {
    ...
    echo "Query Error (report_resolve.php stmt1->prepare) : $stmt1->errno : $stmt1->error";
    $response_msg = "failed";
}
...
if ($response_msg != "failed") {
    ...
    WHERE transaction_id = ?;")) {
        ...
        echo "Query Error (report_resolve.php stmt2->prepare) : $stmt2->errno : $stmt2->error";
        $response_msg = "failed";
    }
}

if ($response_msg != "failed") {
    notif_insert(4, $transaction_id, $admin_id);
}
