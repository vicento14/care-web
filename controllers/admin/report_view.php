...
WHERE assistance_transactions.transaction_id = ?;")) {
    ...
    echo "Query Error (report_view.php stmt1->prepare) : $stmt1->errno : $stmt1->error";
}
...
WHERE admin_id = ?;")) {
    ...
    echo "Query Error (report_view.php stmt2->prepare) : $stmt2->errno : $stmt2->error";
}
...
WHERE account_id = ?;")) {
    ...
    echo "Query Error (report_view.php stmt3->prepare) : $stmt3->errno : $stmt3->error";
}
