...
WHERE transaction_id = ?;")) {
    ...
    echo "Query Error (report_concerns_resolve.php stmt1->prepare) : $stmt1->errno : $stmt1->error";
    $response_msg = "failed";
}
...
if ($response_msg != "failed") {
    ...
    WHERE transaction_id = ?;")) {
        ...
        echo "Query Error (report_concerns_resolve.php stmt2->prepare) : $stmt2->errno : $stmt2->error";
        $response_msg = "failed";
    }
}
