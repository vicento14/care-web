...
WHERE assistance_transactions.report_type_id = 0 
AND assistance_transactions.dept_id = ?")) {
    // Bind parameters
    ...
    echo "Query Error (report_complaints_load.php stmt1->prepare) : $stmt1->errno : $stmt1->error";
}
